...
object MovieRecommendation {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val readConfig = ReadConfig(Map("uri" -> "mongodb://0.0.0.0:27017/movies.movie_ratings?readPreference=primaryPreferred"))
    val writeConfig = WriteConfig(Map("uri" -> "mongodb://0.0.0.0:27017/movies.user_recommendations"))
    val userId = 0
